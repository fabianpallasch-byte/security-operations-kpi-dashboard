...
- [`docs/Projekt_SQL_PowerBI_Fabian_Pallasch.pdf`](docs/Projekt_SQL_PowerBI_Fabian_Pallasch.pdf) – kurze Projektbeschreibung
- [`sql/security_kpi_queries.sql`](sql/security_kpi_queries.sql) – verwendete SQL-Abfragen
